...
if(ContaoEstateManager\Project\AddonManager::valid()) {
    ...
    (
        ...
        'projectChildrenList'     => '{title_legend},name,headline,type;{settings_legend},childrenObserveFiltering;{template_legend:hide},customTpl,projectChildrenListTemplate,realEstateTemplate;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID',
