...
if(ContaoEstateManager\Project\AddonManager::valid()) {
    ...
    // Add fields
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['projectDetailsTemplate'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['projectMarketingStatusTemplate'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['projectChildrenListTemplate'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['projectCompletionStatusTemplate'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['projectDetails'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['completionStatus'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['childrenObserveFiltering'] = array
    (
    ...
    $GLOBALS['TL_DCA']['tl_expose_module']['fields']['hideOnZeroPercent'] = array
    (
